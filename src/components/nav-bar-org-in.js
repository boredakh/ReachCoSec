...
const NavBarOrgIn = (props) => {
  ...
  return (
    <header className={`nav-bar-org-in-container1 ${props.rootClassName} `}>
      <header
        data-thq="thq-navbar"
        className="nav-bar-org-in-navbar-interactive"
      >
        <Link to="/homeinorg" className="nav-bar-org-in-navlink1">
          <img
            alt={props.imageAlt}
            src={props.imageSrc}
            className="nav-bar-org-in-image1"
          />
        </Link>
        <div data-thq="thq-navbar-nav" className="nav-bar-org-in-desktop-menu">
          <nav className="nav-bar-org-in-links1">
            <Link
              to="/about-us-in-org"
              className="nav-bar-org-in-link11 thq-link thq-body-small"
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="nav-bar-org-in-text24">About Us</span>
                </Fragment>
              )}
            </Link>
            <Link
              to="/blogs-in-org"
              className="nav-bar-org-in-link21 thq-link thq-body-small"
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="nav-bar-org-in-text30">Blogs</span>
                </Fragment>
              )}
            </Link>
          </nav>
          <div className="nav-bar-org-in-buttons1">
            <Link
              ...
              className="nav-bar-org-in-action11 thq-button-filled thq-button-animated"
            >
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="nav-bar-org-in-text29">
                      Find Opportunities
                    </span>
                  </Fragment>
                )}
            ...
            <Link
              ...
              className="nav-bar-org-in-action12 thq-button-filled thq-button-animated"
            >
              <span>
                {props.action11 ?? (
                  <Fragment>
                    <span className="nav-bar-org-in-text20">
                      Find Volunteers
                    </span>
                  </Fragment>
                )}
            ...
            <div
              ...
              className="nav-bar-org-in-thq-dropdown list-item"
            >
              <div
                data-thq="thq-dropdown-toggle"
                className="nav-bar-org-in-dropdown-toggle1"
              >
                <img
                  alt={props.imageAlt2}
                  src={props.imageSrc2}
                  className="nav-bar-org-in-image2"
                />
                <div
                  data-thq="thq-dropdown-arrow"
                  className="nav-bar-org-in-dropdown-arrow"
                >
                  <svg
                    viewBox="0 0 1024 1024"
                    className="nav-bar-org-in-icon10"
                  >
              ...
              <ul
                ...
                className="nav-bar-org-in-dropdown-list"
              >
                <li
                  data-thq="thq-dropdown"
                  className="nav-bar-org-in-dropdown1 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="nav-bar-org-in-dropdown-toggle2"
                  >
                    <button
                      type="button"
                      className="nav-bar-org-in-button button"
                    >
                      <Link
                        to="/find-volunteers-in"
                        className="nav-bar-org-in-navlink2"
                      >
                        {props.button121 ?? (
                          <Fragment>
                            <span className="nav-bar-org-in-text19">
                              Profile
                            </span>
                          </Fragment>
                        )}
                ...
                <li
                  data-thq="thq-dropdown"
                  className="nav-bar-org-in-dropdown2 list-item"
                >
                  <div
                    data-thq="thq-dropdown-toggle"
                    className="nav-bar-org-in-dropdown-toggle3"
                  >
                    <Link to="/" className="nav-bar-org-in-navlink3 button">
                      <span>Sign Out</span>
                    </Link>
                  </div>
                </li>
          ...
          <div className="nav-bar-org-in-nav">
            <div className="nav-bar-org-in-top">
              <img
                alt={props.logoAlt}
                src={props.logoSrc}
                className="nav-bar-org-in-logo"
              />
              <div
                data-thq="thq-close-menu"
                className="nav-bar-org-in-close-menu"
              >
            ...
            <nav className="nav-bar-org-in-links2">
              <a
                href={props.link1Url}
                className="nav-bar-org-in-link12 thq-link thq-body-small"
              >
                {props.link1 ?? (
                  <Fragment>
                    <span className="nav-bar-org-in-text24">About Us</span>
              ...
              <a
                href={props.link3Url}
                className="nav-bar-org-in-link3 thq-link thq-body-small"
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="nav-bar-org-in-text28">Link 3</span>
                  </Fragment>
                )}
              </a>
              <div className="nav-bar-org-in-link4-accordion">
                <div
                  ...
                  className="nav-bar-org-in-trigger"
                >
                  <span className="thq-link thq-body-small">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="nav-bar-org-in-text15">Link 4</span>
                      </Fragment>
                    )}
                  </span>
                  <div className="nav-bar-org-in-icon-container">
                    {link5AccordionOpen && (
                      <div className="nav-bar-org-in-container2">
                        <svg
                          viewBox="0 0 1024 1024"
                          className="nav-bar-org-in-icon16"
                        >
                    ...
                    {!link5AccordionOpen && (
                      <div className="nav-bar-org-in-container3">
                        <svg
                          viewBox="0 0 1024 1024"
                          className="nav-bar-org-in-icon18"
                        >
                          <path d="M426 726v-428l214 214z"></path>
                        </svg>
                      </div>
                        ...
                        <div className="nav-bar-org-in-content1">
                          ...
                          <span className="thq-body-small">
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="nav-bar-org-in-text21">
                        ...
                        <div className="nav-bar-org-in-content2">
                          ...
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="nav-bar-org-in-text26">
                        ...
                        <div className="nav-bar-org-in-content3">
                          ...
                          <span className="thq-body-small">
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="nav-bar-org-in-text23">
                        ...
                        <div className="nav-bar-org-in-content4">
                          ...
                          <span className="thq-body-small">
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="nav-bar-org-in-text27">
            ...
            <div className="nav-bar-org-in-buttons2">
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="nav-bar-org-in-text18">Log in</span>
                    </Fragment>
                  )}
                </span>
              </button>
              ...
              <a href={props.linkUrlPage1}>
                <div className="nav-bar-org-in-menu-item5">
                  <img
                    alt={props.page1ImageAlt}
                    src={props.page1ImageSrc}
                    className="nav-bar-org-in-page1-image2 thq-img-ratio-1-1"
                  />
              ...
              <a href={props.linkUrlPage2}>
                <div className="nav-bar-org-in-menu-item6">
                  <img
                    alt={props.page2ImageAlt}
                    src={props.page2ImageSrc}
                    className="nav-bar-org-in-page2-image2 thq-img-ratio-1-1"
                  />
              ...
              <a href={props.linkUrlPage3}>
                <div className="nav-bar-org-in-menu-item7">
                  <img
                    alt={props.page3ImageAlt}
                    src={props.page3ImageSrc}
                    className="nav-bar-org-in-page3-image2 thq-img-ratio-1-1"
                  />
              ...
              <a href={props.linkUrlPage4}>
                <div className="nav-bar-org-in-menu-item8">
                  <img
                    alt={props.page4ImageAlt}
                    src={props.page4ImageSrc}
                    className="nav-bar-org-in-page4-image2 thq-img-ratio-1-1"
                  />
      ...
      {link5DropdownVisible && (
        <div
          ...
          className="nav-bar-org-in-container6"
        ></div>
      )}
    </header>
  )
