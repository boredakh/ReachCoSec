  ...
  return (
    <div className="opportunities-out-container">
      ...
      <SearchBar
        ...
        text11={
          <Fragment>
            <span className="opportunities-out-text29">Postcode:</span>
          </Fragment>
        }
        text111={
          <Fragment>
            <span className="opportunities-out-text30">Keyword:</span>
          </Fragment>
        }
        plan2Price={
          <Fragment>
            <span className="opportunities-out-text31">
        ...
        plan1Price1={
          <Fragment>
            <span className="opportunities-out-text35">$200/yr</span>
          </Fragment>
        }
        plan2Price1={
          <Fragment>
            <span className="opportunities-out-text36">$299/yr</span>
          </Fragment>
        }
        plan3Price1={
          <Fragment>
            <span className="opportunities-out-text37">$499/yr</span>
          </Fragment>
        }
        plan1Action1={
          <Fragment>
        ...
        plan1Yearly1={
          <Fragment>
            <span className="opportunities-out-text39">or $20 monthly</span>
          </Fragment>
        }
        plan2Action1={
          <Fragment>
        ...
        plan2Yearly1={
          <Fragment>
            <span className="opportunities-out-text41">or $29 monthly</span>
          </Fragment>
        }
        plan3Action1={
          <Fragment>
            <span className="opportunities-out-text42">Get started</span>
          </Fragment>
        }
        plan3Yearly1={
          <Fragment>
            <span className="opportunities-out-text43">or $49 monthly</span>
          </Fragment>
        }
        ...
        plan3Feature41={
          <Fragment>
            <span className="opportunities-out-text54">
              Feature text goes here
            </span>
          </Fragment>
        }
        plan3Feature51={
          <Fragment>
            <span className="opportunities-out-text55">
              Feature text goes here
            </span>
          </Fragment>
        }
      ...
      <H2random
        heading={
          <Fragment>
            <span className="opportunities-out-text56">Results</span>
          </Fragment>
        }
      ></H2random>
      <Results></Results>
      <Footer
        link1={
          <Fragment>
            <span className="opportunities-out-text57">About us</span>
          </Fragment>
        }
        link2={
          <Fragment>
            <span className="opportunities-out-text58">Help</span>
          </Fragment>
        }
        link3={
          <Fragment>
            <span className="opportunities-out-text59">Contact us</span>
          </Fragment>
        }
        link4={
          <Fragment>
            <span className="opportunities-out-text60">Blogs</span>
          </Fragment>
        }
        link5={
          <Fragment>
            <span className="opportunities-out-text61">
              Terms &amp; Privacy
            </span>
          </Fragment>
        }
        link7={
          <Fragment>
            <span className="opportunities-out-text62">Find Opportunities</span>
          </Fragment>
        }
        link8={
          <Fragment>
            <span className="opportunities-out-text63">Find Volunteers</span>
          </Fragment>
        }
        termsLink={
          <Fragment>
            <span className="opportunities-out-text64">Terms of Service</span>
          </Fragment>
        }
        cookiesLink={
          <Fragment>
            <span className="opportunities-out-text65">Cookies Settings</span>
          </Fragment>
        }
        privacyLink={
          <Fragment>
            <span className="opportunities-out-text66">Privacy Policy</span>
          </Fragment>
        }
